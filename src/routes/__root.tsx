  ...
  head: () => ({
    meta: [
      ...
      { title: "MedLens — Clinical information intelligence" },
      {
        name: "description",
        content:
          "MedLens turns scattered medical documents into a structured, traceable and verified health record.",
      },
      { property: "og:title", content: "MedLens" },
      {
        property: "og:description",
        content: "Turn messy medical documents into a traceable patient record.",
      },
